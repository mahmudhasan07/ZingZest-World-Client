...
import profile from '../../../public/user.json'
import Lottie from "lottie-react";
    ...
    return (
        <section className="my-7">
            ...
            <div>
                {
                    data == "l" ?
                        <Lottie animationData={profile} className="w-96 myd-12 mx-auto" ></Lottie>

                        :
                        <div className="w-1/2 mx-auto border-2 border-gray-600 p-5 bg-slate-100 rounded-2xl">
                            <div className="border-4 w-72 mx-auto border-blue-500 rounded-full">
                                <img className="rounded-full w-72 h-72 object-cover object-top" src={data.imageHost} alt="" />
                            </div>
